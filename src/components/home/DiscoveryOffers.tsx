    ...
    <section className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {offers.map((o) => (
            <div key={o.title} className="p-7 rounded-2xl border border-gray-200 bg-white hover:border-[#FF5A1F] hover:shadow-lg hover:shadow-orange-100 transition-all duration-200 flex flex-col">
              <div className="flex items-center justify-between mb-5">
                <div className="w-11 h-11 rounded-xl flex items-center justify-center bg-orange-50">
                  <o.icon size={20} className="text-[#FF5A1F]" />
                </div>
                <span className="text-xs font-semibold text-[#FF5A1F] bg-orange-50 border border-orange-100 rounded-full px-3 py-1">{o.tag}</span>
              </div>
              ...
              <div className="flex items-center justify-between pt-5 border-t border-gray-100">
                <span className="text-2xl font-bold text-[#FF5A1F]">{o.price}</span>
                <Link href="/contact#message" className="inline-flex items-center gap-1.5 text-sm font-semibold text-gray-700 hover:text-[#FF5A1F] transition-colors">
