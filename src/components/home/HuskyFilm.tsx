...
const COPY = {
  fr: {
    ...
    a5h: "Par où on commence ?", a5p: "Un échange de 20 minutes avec Benjamin. On repère le premier système qui vous fait gagner du temps.",
  ...
  en: {
    ...
    a5h: "Where do we start?", a5p: "A 20-minute chat with Benjamin. We spot the first system that saves you time.",
  ...
  useEffect(() => {
    ...
    function render() {
      ...
      if (rings) {
        ...
        rings.style.opacity = (0.45 + 0.4 * Math.sin(fr * Math.PI)).toFixed(3);
      }
