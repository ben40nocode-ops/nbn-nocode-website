    ...
    <section className="pt-32 pb-24 bg-white">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
          <div className="inline-flex items-center gap-2 bg-orange-50 border border-orange-100 text-[#FF5A1F] rounded-full px-4 py-1.5 text-xs font-semibold tracking-wide uppercase">
            Automatisation pour PME & Artisans
          </div>
          <div className="inline-flex items-center gap-2 bg-[#fff5f0] border border-[#FF5A1F]/20 text-[#d97757] rounded-full px-3 py-1 text-xs font-medium">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-gray-900 leading-tight tracking-tight mb-6">
          ...
          <span className="text-[#FF5A1F]">Même quand vous dormez.</span>
        </h1>
