...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.nbn-ia.fr/blog/${slug}`,
      languages: {
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="mb-10">
            ...
            <div className="flex flex-wrap items-center gap-5 text-xs text-gray-400 pb-8 border-b border-gray-100">
              ...
              <span className="flex items-center gap-1.5"><Clock size={12} /> {article.readingTime} de lecture</span>
            </div>
          </div>
          ...
          <div className="mt-16 bg-gray-900 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">Audit gratuit 1h — on identifie ensemble les 3 automatisations les plus rentables pour vous.</p>
            <Link
          ...
          {related.length > 0 && (
            <div className="mt-16">
              <h2 className="text-lg font-bold text-gray-900 mb-6">Articles similaires</h2>
