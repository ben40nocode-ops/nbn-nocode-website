...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.nbn-ia.fr/en/web-apps",
    languages: {
      ...
      <div className="min-h-screen bg-white pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="bg-gray-900 rounded-3xl p-12 text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-md mx-auto">Free 30-minute audit. We map your product, propose the architecture. No commitment.</p>
            <Link href="https://calendly.com/ben40nocode/1h" target="_blank" rel="noopener noreferrer"
