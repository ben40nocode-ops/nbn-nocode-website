...
export default function RoyanEnPage() {
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
          ...
          <span className="text-[#FF5A1F]">in Royan, France</span>
        </h1>
        <p className="text-lg text-gray-500 max-w-2xl mb-10 leading-relaxed">
          NBN IA serves businesses in Royan and the surrounding Charente-Maritime coast. We build autonomous AI systems with Claude AI agents, custom web apps, and digital automations that run 24/7 without human intervention.
        </p>
        ...
        <div className="bg-gray-50 rounded-2xl p-10 mb-20">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Why NBN IA in Royan?</h2>
          <ul className="space-y-4">
            {[
              "Local presence in Royan — we meet in person or work 100% remote",
        ...
        <div className="bg-gray-900 rounded-3xl p-12 text-center">
          <h2 className="text-white font-bold text-2xl mb-3">Ready to automate in Royan?</h2>
