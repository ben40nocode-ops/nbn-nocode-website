...
export const metadata: Metadata = {
  title: "Web App Restaurant Bordeaux | NBN IA",
  description: "Gestion commandes, stocks, équipe pour restaurants Bordeaux. Devis gratuit.",
  keywords: ["app restaurant bordeaux"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Web App Restaurant Bordeaux</h1>
        <p className="text-lg text-gray-500 mb-10">Gestion commandes, stocks, équipe pour restaurants Bordeaux.</p>
