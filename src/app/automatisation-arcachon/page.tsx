...
export const metadata: Metadata = {
  ...
  description: "Expert agents IA et automatisation à Arcachon et Bassin d'Arcachon. Claude AI, Make, Airtable. Audit 1h pour hôtels, restaurants, ostréiculteurs et PME locales.",
