...
export const metadata: Metadata = {
  ...
  keywords: [
    "web app Arcachon",
    "développement application Arcachon",
    "application IA Arcachon",
  ...
  openGraph: {
    title: "Web App IA à Arcachon — NBN IA",
    description: "Développement d'applications web et web apps IA à Arcachon. Sur mesure, sécurisées, performantes.",
    url: "https://www.nbn-ia.fr/web-app-arcachon",
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  name: "Développement Web App IA à Arcachon",
  provider: { "@type": "Organization", name: "NBN IA", url: "https://www.nbn-ia.fr" },
  areaServed: { "@type": "City", name: "Arcachon" },
  description: "Développement d'applications web sur mesure avec authentification, base de données, intégrations IA et APIs pour les PME d'Arcachon.",
};

export default function WebAppArcachonPage() {
  return (
    <>
      ...
      <div className="min-h-screen bg-white pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="inline-flex items-center gap-2 bg-orange-50 border border-orange-100 text-[#e8632a] rounded-full px-4 py-1.5 text-xs font-semibold mb-8 tracking-wide uppercase">
            <Layers size={12} /> Web App IA — Arcachon
          </div>
