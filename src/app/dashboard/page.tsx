      ...
      return (
        <div className="min-h-screen bg-gray-50 pt-24 pb-16 flex items-center justify-center">
          <div className="text-center max-w-md mx-auto px-6">
            <div className="w-16 h-16 border-4 border-[#FF5A1F] border-t-transparent rounded-full animate-spin mx-auto mb-6" />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {PLANS.map((plan) => (
              <div
                key={plan.key}
                className="group relative p-8 rounded-2xl border border-gray-200 bg-white hover:border-[#FF5A1F] hover:shadow-xl hover:shadow-orange-100 transition-all duration-300 flex flex-col"
              >
                ...
                <a
                  ...
                  className="w-full text-center py-3 rounded-xl text-sm font-bold transition-colors duration-200 bg-[#FF5A1F] hover:bg-[#E64A12] text-white"
                >
                  S&apos;abonner
                </a>
              </div>
