...
export const metadata: Metadata = {
  ...
  description: "Création d'application web sur mesure à Royan : espace client, réservation, gestion. Web apps IA dès 2 500 €. Audit gratuit 30 min, sans engagement.",
  keywords: [
