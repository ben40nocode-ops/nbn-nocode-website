...
export default function Page() {
  return (
    <SectorPage
      ...
      steps={[
        { step: "01", title: "Brief & design (30 min)", desc: "On définit les fonctionnalités, le ton et les visuels. Pour Montalivet, on sait valoriser le cadre naturel et la clientèle spécifique." },
