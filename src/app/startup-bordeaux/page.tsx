...
export const metadata: Metadata = {
  title: "Startup Bordeaux | NBN IA",
  description: "Web app + landing page startup Bordeaux. Growth ready. Devis gratuit.",
  keywords: ["startup bordeaux"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Startup Bordeaux</h1>
        <p className="text-lg text-gray-500 mb-10">Web app + landing page startup Bordeaux. Growth ready.</p>
