...
export const metadata: Metadata = {
  ...
  description: "Expert en agents IA et automatisation IA à Bordeaux. Faites tourner vos process sans recruter. Make, Claude AI, Airtable. Audit gratuit 1h pour PME bordelaises.",
