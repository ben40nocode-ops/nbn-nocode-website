...
export const metadata: Metadata = {
  ...
  description: "Expert agents IA et automatisation à Bordeaux. Faites tourner vos process sans recruter. Make, Claude AI, Airtable. Audit gratuit 30 min pour PME bordelaises.",
      ...
      <div className="min-h-screen pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-[3.4rem] font-extrabold text-[#0E1116] leading-[1.04] tracking-[-0.03em] mb-6">
            ...
            <span className="text-[#FF5A1F]">pour les PME de Bordeaux</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-20">
            <div>
              <h2 className="text-2xl font-extrabold text-[#0E1116] tracking-[-0.02em] mb-4">Ce qu&apos;on automatise pour les entreprises bordelaises</h2>
            ...
            <div className="bg-white border border-[#E2E0DA] rounded-2xl p-7 shadow-[0_14px_34px_rgba(14,17,22,.06)]">
              <h2 className="text-lg font-extrabold text-[#0E1116] mb-3">Pourquoi NBN IA à Bordeaux ?</h2>
          ...
          {/* Comment ça marche */}
          <div className="mb-20">
            <h2 className="text-2xl font-extrabold text-[#0E1116] tracking-[-0.02em] mb-8">Comment on travaille avec les PME de Bordeaux</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { step: "01", title: "Audit gratuit 30 min", desc: "On cartographie ensemble vos process : ce qui prend du temps, ce qui peut être automatisé, ce qui ne peut pas l'être. Pas de jargon, pas d'engagement." },
          ...
          {/* FAQ */}
          <div className="mb-20">
            <h2 className="text-2xl font-extrabold text-[#0E1116] tracking-[-0.02em] mb-8">Questions fréquentes — automatisation IA à Bordeaux</h2>
