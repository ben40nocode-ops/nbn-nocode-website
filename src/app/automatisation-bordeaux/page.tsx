...
export const metadata: Metadata = {
  ...
  description: "Expert en automatisation nocode et agents IA à Bordeaux. Faites tourner vos process sans recruter. Make, Zapier, Airtable, Claude AI. Audit gratuit 30 min.",
