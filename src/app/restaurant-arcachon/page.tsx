...
export const metadata: Metadata = {
  title: "Restaurant Arcachon | NBN IA",
  description: "Site restaurant Arcachon + automations cuisine/stocks. Devis gratuit.",
  keywords: ["restaurant arcachon"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Restaurant Arcachon</h1>
        <p className="text-lg text-gray-500 mb-10">Site restaurant Arcachon + automations cuisine/stocks.</p>
