...
export const metadata: Metadata = {
  ...
  description: "Sites web et applications sur mesure à Bordeaux. Next.js, vibe coding avec Claude Code. Rapide, performant, connecté à vos automatisations IA. Devis gratuit.",
