...
export const metadata: Metadata = {
  ...
  description: "Création de sites web et applications sur mesure à Bordeaux. Next.js, Webflow, vibe coding avec Claude Code. Rapide, performant, connecté à vos automatisations IA. Devis gratuit.",
