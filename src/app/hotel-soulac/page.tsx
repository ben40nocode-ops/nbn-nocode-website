...
export const metadata: Metadata = {
  title: "Hôtel Soulac | NBN IA",
  description: "Site vitrine + booking pour hôtels Soulac. Saison optimisée. Devis gratuit.",
  keywords: ["hotel soulac"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Hôtel Soulac</h1>
        <p className="text-lg text-gray-500 mb-10">Site vitrine + booking pour hôtels Soulac. Saison optimisée.</p>
