...
export const metadata: Metadata = {
  title: "Pêcherie Royan | NBN IA",
  description: "Site vente poisson frais Royan. Livraisons, B2B restaurants. Devis gratuit.",
  keywords: ["peche royan"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Pêcherie Royan</h1>
        <p className="text-lg text-gray-500 mb-10">Site vente poisson frais Royan. Livraisons, B2B restaurants.</p>
