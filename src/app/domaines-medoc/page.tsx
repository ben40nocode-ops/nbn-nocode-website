...
export const metadata: Metadata = {
  title: "Médoc Vignoble | NBN IA",
  description: "Site vitrine + e-commerce pour domaines Médoc. Tourisme & ventes. Devis gratuit.",
  keywords: ["domaines medoc"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Médoc Vignoble</h1>
        <p className="text-lg text-gray-500 mb-10">Site vitrine + e-commerce pour domaines Médoc. Tourisme & ventes.</p>
