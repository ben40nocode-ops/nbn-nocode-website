...
export const metadata: Metadata = {
  title: "Domaine Viticole Lesparre | NBN IA",
  description: "Site + app pour caves Lesparre. Œnotourisme, ventes. Devis gratuit.",
  keywords: ["cave lesparre"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Domaine Viticole Lesparre</h1>
        <p className="text-lg text-gray-500 mb-10">Site + app pour caves Lesparre. Œnotourisme, ventes.</p>
