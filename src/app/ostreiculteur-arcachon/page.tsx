...
export default function Page() {
  return (
    <SectorPage
      ...
      faqs={[
        { q: "C'est adapté à une petite cabane ?", a: "Oui. Un producteur qui reçoit 20 commandes par semaine peut déjà gagner 30 min par jour avec une automatisation simple à 450€." },
