...
export const metadata: Metadata = {
  title: "Ostréiculteur Arcachon | NBN IA",
  description: "Site + app vente huîtres Arcachon. B2B & B2C. Devis gratuit.",
  keywords: ["ostreiculteur arcachon"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Ostréiculteur Arcachon</h1>
        <p className="text-lg text-gray-500 mb-10">Site + app vente huîtres Arcachon. B2B & B2C.</p>
