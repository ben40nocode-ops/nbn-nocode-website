...
export const metadata: Metadata = {
  title: "Web App Hôtel Arcachon | NBN IA",
  description: "Gestion réservations, personnelèle, inventaire pour hôtels Arcachon. Devis gratuit.",
  keywords: ["app hotel arcachon"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Web App Hôtel Arcachon</h1>
        <p className="text-lg text-gray-500 mb-10">Gestion réservations, personnelèle, inventaire pour hôtels Arcachon.</p>
