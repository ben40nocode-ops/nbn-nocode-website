...
export const metadata: Metadata = {
  title: "Vente Poisson Arcachon | NBN IA",
  description: "App e-commerce poisson frais Arcachon. Chaîne froid. Devis gratuit.",
  keywords: ["poisson arcachon"],
};
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Vente Poisson Arcachon</h1>
        <p className="text-lg text-gray-500 mb-10">App e-commerce poisson frais Arcachon. Chaîne froid.</p>
