...
export const metadata: Metadata = {
  title: "Automatisation IA — Filière Poisson à Arcachon",
...
export default function Page() {
  return (
    <SectorPage
      ...
      casesTitle="Cas d’usage pour la filière poisson Arcachon"
      cases={[
        {
        ...
        },
        {
          ...
          gain: "Mettre à jour les stocks en temps réel et prévenir les clients concernés.",
        },
      ]}
      faqs={[
        ...
        { q: "Est-ce que ça marche pour une petite structure ?", a: "Oui. Un poissonnier avec 10 clients restaurants réguliers peut bénéficier d'une automatisation simple à 450€ qui lui fait gagner 30 min par jour." },
